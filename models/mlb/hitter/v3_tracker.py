...
Usage:
    python -m models.mlb.hitter.v3_tracker log --start 2026-07-01 --end 2026-07-03
    python -m models.mlb.hitter.v3_tracker log --days 2          # cron: yesterday + safety overlap
    python -m models.mlb.hitter.v3_tracker report
"""
...
from models.mlb.hitter.hitter_prop_dataset import build_dataset
...
def report():
    ...
    from models.mlb.hitter.backtest import american_to_decimal as a2d
