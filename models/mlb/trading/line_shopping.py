...
Usage:
    python -m models.mlb.trading.line_shopping                       # all hitter markets
    python -m models.mlb.trading.line_shopping --sharp 0             # use Consensus instead of Novig
    python -m models.mlb.trading.line_shopping --markets 403,293,289 # specific markets
"""
